...
function Contact() {
    return (
        <div id='contactContainer' className='flex flex-col justify-center gap-y-5 items-center bg-black h-1/4'>
            <h2 className='text-4xl border-b'>Contact</h2>
            <div>
                <ul className='flex gap-x-2'>
                    ...
                    <li className='flex items-center gap-2 bg-darkgray p-2 hover:bg-softgray text-lg'>GitHub <img className='w-6' src='https://cdn-icons-png.flaticon.com/128/919/919847.png'></img></li>
                </ul>
            </div >
        </div >
    )
