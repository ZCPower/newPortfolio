...
function Home() {
    return (
        <div id='homeContainer' className='flex flex-col justify-center'>
            ...
            {/* <video autoPlay muted loop src='https://player.vimeo.com/external/370467553.sd.mp4?s=96de8b923370fb7fa8616d4e0b74eaf3fac9e576&profile_id=164&oauth2_token_id=57447761' /> */}
