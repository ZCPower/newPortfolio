...
function SingleProject({ name, description, logo, image, link, github, preview }) {
    ...
    return (
        <div className='singleProject bg-black w-1/3 shrink-0 flex flex-col justify-between'>
            ...
            <div id='projButtons' className='flex gap-x-2 justify-center items-center pb-2'>
                {github && link ?
                    <>
                        ...
                        <a href={link} target='_blank'><button className='text-base flex gap-2 items-center'><img className='w-8' src='https://cdn-icons-png.flaticon.com/128/870/870169.png'></img>Visit Page</button></a></> : <h4 className='text-xl text-purple pb-3'>Currently under construction!</h4>
                }
